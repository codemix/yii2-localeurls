...
abstract class TestCase extends \PHPUnit\Framework\TestCase
{
    ...
    /**
     * Mock a web application with given config for urlManager component and let it resolve the
     * request
     *
     ...
     * For the `urlManager` component it will use the options that where set with
     * `mockUrlManager()`. Extra configuration passed via `$config` will override any of the above
     * options.
     *
